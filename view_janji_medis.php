            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-55">
                        ...
                        <button class="btn btn-primary" data-toggle="modal" data-target="#login">Buat janji medis</button>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            ...
                            <a href="cetak_janji_medis.php?id=poli_mata" class="learn_more">Cetak kartu antrian</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            ...
                            <a href="cetak_janji_medis.php?id=poli_umum" class="learn_more">Cetak kartu antrian</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            ...
                            <a href="cetak_janji_medis.php?id=poli_gigi" class="learn_more">Cetak kartu antrian</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            ...
                            <a href="cetak_janji_medis.php?id=medical_check_up" class="learn_more">Cetak kartu antrian</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            ...
                            <a href="cetak_janji_medis.php?id=poli_kulit_dan_kelamin" class="learn_more">Cetak kartu antrian</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            ...
                            <a href="cetak_janji_medis.php?id=poli_jantung" class="learn_more">Cetak kartu antrian</a>
                        </div>
                    </div>
                </div>
            </div>
